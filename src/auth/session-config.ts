const DEFAULT_IDLE_TIMEOUT_HOURS = 1;
...
export const AUTH_ACCESS_TOKEN_MAX_AGE = (process.env
  .JWT_ACCESS_TOKEN_MAX_AGE || DEFAULT_ACCESS_TOKEN_MAX_AGE) as JwtExpiresIn;
